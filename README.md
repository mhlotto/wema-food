...
- After Pages finishes, open `https://<your-username>.github.io/amherst-food/docs/` to browse the data. Locally, run `python -m http.server` from repo root and open `http://localhost:8000/docs/`.
